...
export const SHOPPING_STORE_OPTIONS: ShoppingStoreOption[] = [
  {
    ...
    shortLabel: 'BA',
    logoPath: '/shopping-stores/bodega-aurrera.svg',
  ...
  },
  {
    ...
    label: 'Soriana',
    shortLabel: 'SO',
    logoPath: '/shopping-stores/soriana.svg',
  ...
  },
  {
    ...
    label: 'Chedraui',
    shortLabel: 'CH',
    logoPath: '/shopping-stores/chedraui.svg',
  ...
  },
  {
    ...
    label: 'Walmart',
    shortLabel: 'WM',
    logoPath: '/shopping-stores/walmart.svg',
  ...
  },
  {
    ...
    label: "Sam's Club",
    shortLabel: 'SC',
    logoPath: '/shopping-stores/sams-club.svg',
