...
export async function updateExpense(input: UpdateExpenseInput) {
  ...
  const updated = await prisma.$transaction(async (tx) => {
    ...
    if (existing.loan_payment != null) {
      const error = new Error(
        'Cannot update expenses generated by loan payments',
      ) as ExpenseServiceError;
...
export async function toggleExpensePaid(input: TogglePaidInput) {
  ...
  const updated = await prisma.$transaction(async (tx) => {
    ...
    if (existing.loan_payment != null) {
      const error = new Error(
        'Cannot change paid status for loan payment expenses',
      ) as ExpenseServiceError;
      error.code = 'EXPENSE_LOAN_PAYMENT_LOCKED';
      throw error;
    }
...
export async function deleteExpense(input: DeleteExpenseInput) {
  ...
  await prisma.$transaction(async (tx) => {
    ...
    if (expense.loan_payment != null) {
      const error = new Error(
        'Cannot delete expenses generated by loan payments',
      ) as ExpenseServiceError;
      error.code = 'EXPENSE_LOAN_PAYMENT_LOCKED';
      throw error;
    }
