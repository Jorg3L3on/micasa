...
export const metadata: Metadata = {
  ...
  description:
    'Condiciones para usar MiCasa: cuentas, uso aceptable, finanzas informativas y responsabilidad.',
  ...
  return (
    ...
    >
      <p>
        ...
        usar el servicio, aceptas estas condiciones. Si no estás de acuerdo, no
        utilices la plataforma.
      </p>

      <h2>1. El servicio</h2>
      <p>
        MiCasa es una herramienta de planificación financiera personal y del hogar
        (quincenas, gastos, ingresos, billeteras, tarjetas, préstamos y módulos
        relacionados). El producto puede estar en evolución; funciones pueden
        cambiar, pausarse o retirarse con aviso razonable cuando sea posible.
      </p>

      <h2>2. Cuentas</h2>
      <ul>
        <li>Debes proporcionar información veraz y mantenerla actualizada.</li>
        <li>Eres responsable de la confidencialidad de tu contraseña y sesión.</li>
        <li>
          Debes tener capacidad legal para contratar en México (o la jurisdicción
          desde la que uses el servicio).
        </li>
        <li>
      ...
      <ul>
        <li>Intentar acceder a datos de otros usuarios o casas sin autorización.</li>
      ...
      <p>
        ...
        carácter informativo y de organización personal. <strong className="text-foreground">No
        constituyen asesoría financiera, fiscal, contable ni de inversión.</strong>{' '}
      ...
      <p>
        Si participas en un contexto de casa/hogar, entiendes que otros miembros
        autorizados pueden ver o editar información según los roles del producto.
        Gestiona invitaciones y roles con cuidado.
      </p>

      <h2>6. Propiedad intelectual</h2>
      <p>
        MiCasa, su marca, diseño e interfaz son de sus titulares. Conservas la
        titularidad de los datos financieros que capturas; nos otorgas una licencia
        limitada para hospedarlos y procesarlos solo para prestar el servicio.
      </p>

      <h2>7. Disponibilidad y garantía</h2>
      <p>
        El servicio se ofrece “tal cual” y “según disponibilidad”. No garantizamos
        disponibilidad ininterrumpida ni ausencia total de errores. Haremos
        esfuerzos razonables por mantener continuidad y corregir fallas
        materiales.
      </p>
      ...
      <p>
        ...
        responsabilidad agregada por reclamaciones relacionadas con el servicio se
        limitará, cuando la ley lo permita, al monto que hayas pagado por MiCasa
        en los 12 meses previos (o cero si el uso fue gratuito).
      </p>
