...
import { GET as getProtectedResourceApiMcp } from '@/app/.well-known/oauth-protected-resource/api/mcp/route';
...
describe('well-known OAuth routes', () => {
  ...
  it('GET /.well-known/oauth-protected-resource/api/mcp', async () => {
    const response = getProtectedResourceApiMcp(
