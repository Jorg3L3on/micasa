      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-xl text-sm text-muted-foreground">
            La línea es lo que aún debes de préstamos y tarjetas. No incluye gastos fijos como renta o suscripciones. Los puntos verdes son el mes en que terminas un préstamo o una compra a meses.
          </p>
        </div>
